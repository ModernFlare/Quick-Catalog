  ...
  return (
    <>
      <div
        ...
        className={cn(
          "product-card group rounded-2xl border bg-card p-4 shadow-sm hover:shadow-lg transition-all duration-300 relative overflow-hidden cursor-pointer",
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-between pt-3 mt-2 border-t border-border">
            ...
            {qty === 0 ? (
              ...
              <div className="flex items-center gap-1 bg-primary/10 rounded-full px-1 py-0.5" onClick={stop}>
                <Button
                  size="icon"
                  variant="ghost"
      ...
      <ProductDetailsDialog product={product} open={open} onOpenChange={setOpen} />
    </>
  );
};
